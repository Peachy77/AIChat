...
//        final ChatMessage systemMessage = ChatMessage.builder().role(ChatMessageRole.SYSTEM).content("你是一个java专家").build();
...
//                .botId("bot-20251128105200-c4lxk")
//                .messages(messages)
//                .build();
//
...
//        }
        ...
        String systemPrompt = "你是一个java专家";
